...
get_cladogram(data = phylo_dist, "data/phylo/species.dist.rda", "gpsec")
get_cladogram(data = phylo_dist, filename = "data/phylo/genus.dist.rda", 
              type = "genus")
```
...
save(species_all, file = "data/phylo/joined.species.rda")
