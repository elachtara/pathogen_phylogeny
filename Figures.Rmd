...
pdf(file = "figures/TREE/genus.pdf", width = 6, height = 8)
plot(my_nj, cex = 0.3, edge.width = 0.3)
```
...
colnames(coefs) <- c('Model', 'Coef', 'p')
coefs <- coefs %>% filter(Model %in% c('B','N/H', 'H', 'B/H', 'N'))
